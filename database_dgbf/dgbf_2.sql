...
--
-- Hôte : localhost
-- Généré le : sam. 16 avr. 2022 à 22:29
...
(0000000015, 'Retrait du bulletin de solde', '2022-03-25 07:31:06', 'Vendredi 13 Mai 2022', '15h00 - 15h45 ', 'En attente', 'attest789c', 36, 1, 3),
(0000000016, 'Retrait du bulletin de solde', '2022-03-25 11:19:34', 'Lundi 09 Mai 2022', '9h30 - 10h30 ', 'En attente', '444', 36, 1, 1);
...
(36, 'fally ipupa', 'El Mara', 'moh.fofana21@gmail.com', '+225 08 78963210', '896633d74462aae566ff42d1fa020777', 'TG9KU5YBI2', '2022-04-13 09:41:46', '2022-03-09 12:55:04', 1),
...
--
ALTER TABLE `horaire_joursprestations`
  MODIFY `IdHoraireJrsPres` int UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `joursprestations`
  MODIFY `IdJrsPres` int UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `rendez_vous`
  MODIFY `NumRdv` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
