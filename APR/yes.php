...
<?php include('navbar_dasboard.php'); ?>
    <div class="container">
		...
		$equal = $_POST['equal'];
		mysqli_query($conn,"insert into schedule (member_id,date,service_id,number,status) values('$session_id1','$date1','$service1','$equal','Pending')")or die(mysqli_error($conn));
		?>
